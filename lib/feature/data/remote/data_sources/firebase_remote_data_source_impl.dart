...
import 'package:mynoteapp/feature/data/remote/models/note_model.dart';
import 'package:mynoteapp/feature/data/remote/models/user_model.dart';
  ...
  Future<void> getCreateCurrentUser(UserEntity user) async {
    ...
    userCollectionRef.doc(user.uid).get().then((value) {
      final newUser = UserModel(
          uid: uid, name: user.name, email: user.email, status: user.status)
          .toDocument();
      if (!value.exists) {
